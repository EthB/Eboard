            ...
            if (msg.what == handlerState) {										//if message is what we want
                ...
                if (endOfLineIndex > 0) {                                           // make sure there data before ~
                    ...
                    if (recDataString.charAt(0) == '#')								//if it starts with # we know it is what we are looking for
                    {
                    	...
                    	String sensor3 = recDataString.substring(20, 28);
                        */ //old recording

                        rpm = Double.parseDouble(sensor3)/7;
                    	...
                    	sensorView2.setText(" Motor Current: " + sensor2 + "A");
                        sensorView3.setText(" RPM: " + dblFormat.format(rpm));
                        sensorView4.setText(dblFormat.format((60*rpm*3.26772*3.1415)/(5280*12*2.25)) + "MPH");
